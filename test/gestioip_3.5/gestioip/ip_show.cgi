...
my $rootnet_first_ip_int=$daten{'rootnet_first_ip_int'} || '';
my $rootnet_last_ip_int=$daten{'rootnet_last_ip_int'} || '';
...
$gip->{rootnet_first_ip_int} = $rootnet_first_ip_int if $rootnet_first_ip_int;
$gip->{rootnet_last_ip_int} = $rootnet_last_ip_int if $rootnet_last_ip_int;
...
my $check_input_message="$descr $cat - $redob";
...
my %changed_host_id;
$changed_host_id{$go_to_address_int}=$go_to_address_int;
