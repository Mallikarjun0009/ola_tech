...
my $hide3_v6="&nbsp;&nbsp;<select class='custom-select custom-select-sm m-2' style='width: 6em' name=\\\"sec_level\\\" id=\\\"sec_level\\\"> <option value=\\\"noAuthNoPriv\\\">noAuthNoPriv<\\/option> <option value=\\\"authNoPriv\\\" selected>authNoPriv<\\/option> <option value=\\\"authPriv\\\">authPriv<\\/option><\\/select>";
my $hide4_v6="&nbsp;&nbsp;$$lang_vars{auth_proto_message}";
my $hide5_v6="&nbsp;&nbsp;$$lang_vars{auth_pass_message}";
my $hide6_v6="&nbsp;&nbsp;<select class='custom-select custom-select-sm m-2' style='width: 6em' name=\\\"auth_proto\\\" id=\\\"auth_proto\\\"><option value=\\\"\\\" selected>---<\\/option> <option value=\\\"MD5\\\">MD5<\\/option> <option value=\\\"SHA\\\">SHA<\\/option><\\/select>";
...
<tr><td $align>$$lang_vars{snmp_equipo_message}</td><td colspan="7" $align1><input type="text" class='form-control form-control-sm m-2' style='width: 12em' size="25" name="snmp_node" value="" maxlength="75"> <i>($$lang_vars{ip_o_dns_message})</i></td></tr>
<tr><td><br></td></tr>
...
print <<EOF;
	...
	<td colspan="3" $align1>&nbsp;&nbsp;v4<input type="checkbox" class="m-2" name="ipv4" value="ipv4" checked>&nbsp;&nbsp;&nbsp;v6<input type="checkbox" class="m-2" name="ipv6" value="ipv6">$rtl_helper</td></tr>
	<tr><td><br></td></tr>
EOF
} else {
print <<EOF;
...
<tr><td align="center">&nbsp;&nbsp;<input type="checkbox" class="m-2" name="local_routes" value="local_routes" checked></td><td align="center"><input type="checkbox" class="m-2" name="static_routes" value="static_routes" checked></td><td align="center"><input type="checkbox" class="m-2" name="other_routes" value="other_routes"></td><td align="center"><input type="checkbox" class="m-2" name="ospf_routes" value="ospf_routes"></td><td align="center"><input type="checkbox" class="m-2" name="rip_routes" value="rip_routes"></td><td align="center"><input type="checkbox" class="m-2" name="isis_routes" value="isis_routes"></td><td align="center"><input type="checkbox" class="m-2" name="eigrp_routes" value="eigrp_routes"></td>
<tr><td><br></td></tr>

<tr><td $align>$$lang_vars{snmp_version_message}</td>
<td colspan="7" $align1>&nbsp;&nbsp;<select class='custom-select custom-select-sm m-2' style='width: 6em' name="snmp_version" id="snmp_version" onchange="changeText1(this.value);">
...
</td><td colspan="7" $align1>&nbsp;&nbsp;<input type="password" class='form-control form-control-sm m-2' style='width: 12em' size="10" name="community_string" value="public" maxlength="55"> <span id="Hide12">$$lang_vars{snmp_default_public_message} <img src=\"../imagenes/quick_help.png\" title=\"$$lang_vars{community_explic_message}\" alt=\"help\"></span></td></tr>
...
<tr><td $align><br>$$lang_vars{process_only_net_v4_message}</td><td colspan="7" $align1><br>&nbsp;&nbsp;<input type="text" class='form-control form-control-sm m-2' style='width: 12em' name=\"process_networks_v4\" width="20" maxlength=\"500\"></td></tr>
EOF

if ( $ipv4_only_mode eq "no" ) {
print <<EOF;
<tr><td $align><br>$$lang_vars{process_only_net_v6_message}</td><td colspan="7" $align1><br>&nbsp;&nbsp;<input type="text" class='form-control form-control-sm m-2' style='width: 12em' name=\"process_networks_v6\" width="20" maxlength=\"500\"></td></tr>
EOF
}
...
<tr><td $align><br>$$lang_vars{add_comment_snmp_query_message}</td><td colspan="7" $align1><br><input type="checkbox" class="m-2" name="add_comment" value="y"></td></tr>

<tr><td $align>$$lang_vars{mark_sync_message}</td><td colspan="7" $align1><input type=\"checkbox\" class="m-2" name=\"mark_sync\" value="y" checked></td>
