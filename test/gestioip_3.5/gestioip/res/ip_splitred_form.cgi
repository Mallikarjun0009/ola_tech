...
print "<tr><td align=\"right\">$BM_message</td><td><select class=\"custom-select custom-select-sm\" name=\"new_bm\" size=\"1\">\n";
if ( $ip_version eq "v4" ) {
...
print "<p><form name=\"splitred_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_splitred_check.cgi\">\n";
print "<table border=\"0\">\n";
print "<tr><td>$bitmasks_message</td><td> <input name=\"bitmasks\" type=\"text\" class='form-control form-control-sm display-inline'  size=\"20\" maxlength=\"200\"></td></tr>\n";
print "</table>\n";
