...
if ( $daten{new_range} ) {
	...
	if ( $overlap_found[0] ) {
		...
		print "<tr bgcolor=\"$color\"><td><b>$new_range &nbsp;</b></td>";

		print "<td><i><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' size=\"25\" name=\"descr\" value=\"\" maxlength=\"100\"></i></td><td><select name=\"loc\" class='custom-select custom-select-sm m-2' style='width: 6em' size=\"1\">";
		print "<option></option>";
		...
		print "</td><td>";
		print "<select name=\"cat_net\" class='custom-select custom-select-sm m-2' style='width: 6em' size=\"1\">";
		print "<option></option>";
		$j=0;
		...
		print "<form method=\"POST\" name=\"new_range\" action=\"$server_proto://$base_uri/res/ip_unirred_check.cgi\"><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' name=\"new_range\" size=\"44\" maxlength=\"44\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{submit_message}\" class=\"btn\"><input type=\"hidden\" name=\"red1\" value=\"$red1\"><input type=\"hidden\" name=\"red2\" value=\"$red2\"><input type=\"hidden\" name=\"unirred\" value=\"$daten{unirred}\"></form>\n";
	} else {
		...
		print "$$lang_vars{otro_rango_message}:<br><form method=\"POST\" name=\"new_range_new\" action=\"$server_proto://$base_uri/res/ip_unirred_check.cgi\"><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' name=\"new_range\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{submit_message}\" class=\"btn\"></form>\n";
		print "<script type=\"text/javascript\">";
...
#		if ( $daten{new_range} =~ /^\w+\:\w+\:\w+\:\w+\:\w+\:\w+\:\w+\:\w+\/\d{1,3}\s\d+$/ ) { $gip->print_error("$client_id",$$lang_vars{dos_checkboxes_message}) };
	...
	if ( $prefix[1] ) {
		...
		print "<form method=\"POST\" name=\"new_range\" action=\"$server_proto://$base_uri/res/ip_unirred_check.cgi\"><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' name=\"new_range\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{submit_message}\" class=\"btn\"><input type=\"hidden\" name=\"red1\" value=\"$red1\"><input type=\"hidden\" name=\"red2\" value=\"$red2\"><input type=\"hidden\" name=\"unirred\" value=\"$daten{unirred}\"></form>\n";
		print "<script type=\"text/javascript\">";
