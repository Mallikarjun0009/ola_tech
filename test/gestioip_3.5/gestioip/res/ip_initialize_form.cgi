...
my $hide3_v6="&nbsp;&nbsp;<select class='custom-select custom-select-sm m-2'  style='width: 12em' name=\\\"sec_level\\\" id=\\\"sec_level\\\"> <option value=\\\"noAuthNoPriv\\\">noAuthNoPriv<\\/option> <option value=\\\"authNoPriv\\\" selected>authNoPriv<\\/option> <option value=\\\"authPriv\\\">authPriv<\\/option><\\/select>";
my $hide4_v6="&nbsp;&nbsp;$$lang_vars{auth_proto_message}";
my $hide5_v6="&nbsp;&nbsp;$$lang_vars{auth_pass_message}";
my $hide6_v6="&nbsp;&nbsp;<select class='custom-select custom-select-sm m-2' name=\\\"auth_proto\\\" id=\\\"auth_proto\\\"><option value=\\\"\\\" selected>---<\\/option> <option value=\\\"MD5\\\">MD5<\\/option> <option value=\\\"SHA\\\">SHA<\\/option><\\/select>";
...
print <<EOF;
        ...
        <td colspan="7" $align1>&nbsp;&nbsp;&nbsp;v4<input type="checkbox" class='m-2' name="ipv4" value="ipv4" checked>&nbsp;&nbsp;&nbsp;v6<input type="checkbox" class='m-2' name="ipv6" value="ipv6"><font color=\"white\">x</font></td></tr>
        <tr><td><br></td></tr>
...
print <<EOF;
	...
	<tr><td $align>
        ...
        </td><td colspan="7" $align1>&nbsp;&nbsp;<input type="password" class='form-control form-control-sm m-2' style='width: 12em' size="10" name="community_string" value="public" maxlength="55"> <span id="Hide12">$$lang_vars{snmp_default_public_message}</span></td></tr>
	...
	<tr><td $align><br>$$lang_vars{process_only_net_v4_message}</td><td colspan="7" $align1><br>&nbsp;&nbsp;<input type="text" class='form-control form-control-sm m-2' style='width: 12em' class='form-control form-control-sm m-2' style='width: 12em' name=\"process_networks_v4\" width="20" maxlength=\"500\"></td></tr>
EOF

	if ( $ipv4_only_mode eq "no" ) {
print <<EOF;
		<tr><td $align><br>$$lang_vars{process_only_net_v6_message}</td><td colspan="7" $align1><br>&nbsp;&nbsp;<input type="text" class='form-control form-control-sm m-2' style='width: 12em' class='form-control form-control-sm m-2' style='width: 12em' name=\"process_networks_v6\" width="20" maxlength=\"500\"></td></tr>
EOF
	}
...
print "<tr><td $align><br>$$lang_vars{max_sinc_procs_manage_message}</td><td $align1><br>&nbsp;<select class='custom-select custom-select-sm m-2'  style='width: 6em' name=\"max_procs\" size=\"1\">\n";
...
print "<tr><td $align><br>$$lang_vars{include_spread_nets_message}</td><td $align1><br><input type=\"checkbox\" class='m-2' name=\"include_spreadsheet_networks\" value=\"yes\" checked></td></tr>\n";
print "<tr><td $align><br>$$lang_vars{initialize_known_networks_message}</td><td $align1><br><input type=\"checkbox\" class='m-2' name=\"init_known_networks\" value=\"yes\" checked></td></tr>\n";
print "<tr><td $align><br>$$lang_vars{add_comment_snmp_query_message}</td><td colspan=\"7\" $align1><br><input type=\"checkbox\" class='m-2' name=\"add_comment\" value=\"yes\">(<i>$$lang_vars{add_comment_example_message}</i>)</td></tr>\n";
print "<tr><td><br><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{discover_message}\" name=\"B1\" class=\"btn\"></td></tr>\n";
print "</form>\n";
print "</table>\n";
