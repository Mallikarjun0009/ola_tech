...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"redes\" size=\"1\" onclick=\"mixed.value = '';\">";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"BM\" size=\"1\" onclick=\"mixed.value = '';\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "</td><td></td></tr>\n";
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"mixed\" size=\"1\" onclick=\"redes.value = '';BM.value = '';\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"descr\" size=\"1\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"cat\" size=\"1\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
print "</td><td $align1>$$lang_vars{cat_message}</td></tr>\n";
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"comentario\" size=\"1\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
for ( my $k = 0; $k < scalar(@cc_values); $k++ ) {
    next if $cc_values[$k]->[0] eq "usage";
    print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"$cc_values[$k]->[0]\" size=\"1\">";
    foreach (@nums) {
        print "<option>$_</option>\n";
    }
    print "</select>\n";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"is_rootnet\" size=\"1\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "<tr><td colspan=\"2\" $align1><br><input name=\"spreadsheet\" type=\"hidden\" value=\"$filename\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{importar_message}\" name=\"B1\" class=\"btn\"></td></tr>\n";
print "</form>\n";
print "</table>\n";
