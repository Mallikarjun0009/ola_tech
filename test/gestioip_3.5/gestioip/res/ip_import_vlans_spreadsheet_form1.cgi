...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"vlan_id\" size=\"1\">";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"vlan_name\" size=\"1\"\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"provider\" size=\"1\">";
foreach (@nums) {
	print "<option>$_</option>\n";
}
print "</select>\n";
...
print "<tr><td colspan=\"2\" $align1><p><br><p></td></tr>\n";
print "<tr><td $align><p><input type=\"radio\" name=\"update_comment\" value=\"replace\" checked></td><td $align1><p><br>$$lang_vars{overwrite_description_message}</td></tr>\n";
print "<tr><td $align><p><input type=\"radio\" name=\"update_comment\" value=\"add\"></td><td $align1><p><br>$$lang_vars{add_to_description_message}</td></tr>\n";
print "<tr><td $align><p><input type=\"radio\" name=\"update_comment\" value=\"ignore\"></td><td $align1><p><br>$$lang_vars{ignore_new_description_message}</td></tr>\n";


print "<tr><td colspan=\"2\" $align1><br><p><input name=\"spreadsheet\" type=\"hidden\" value=\"$filename\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{importar_message}\" name=\"B1\" class=\"btn\"></td></tr>\n";
print "</form>\n";
print "</table>\n";
