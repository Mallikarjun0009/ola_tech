...
my $hide7_v6="<input type=\\\"password\\\" class='form-control form-control-sm m-2' style='width: 12em' size=\\\"15\\\" name=\\\"auth_pass\\\" id=\\\"auth_pass\\\" maxlength=\\\"100\\\">";
my $hide8_v6=$$lang_vars{priv_proto_message};
my $hide9_v6=$$lang_vars{priv_pass_message};
my $hide10_v6="<select class='custom-select custom-select-sm m-2' style='width: 6em' name=\\\"priv_proto\\\" id=\\\"priv_proto\\\"> <option value=\\\"\\\" selected>---<\\/option> <option value=\\\"DES\\\" >DES<\\/option> <option value=\\\"3DES\\\">3DES<\\/option> <option value=\\\"AES\\\">AES<\\/option><\\/select>";
my $hide11_v6="<input type=\\\"password\\\" class='form-control form-control-sm m-2' style='width: 12em' size=\\\"15\\\" name=\\\"priv_pass\\\" id=\\\"priv_pass\\\" maxlength=\\\"100\\\">";
...
print "<tr><td $align><b>$$lang_vars{snmp_equipo_message}</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"node\" onclick=\"$onclick_opt\" checked></td><td colspan=\"3\" $align1><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' class='form-control form-control-sm m-2' style='width: 12em' size=\"25\" name=\"snmp_node\" value=\"\" maxlength=\"75\"> <i>($$lang_vars{ip_o_dns_message})</i></td></tr>\n";
...
if ( $l2devices[0] ) {
	...
	$l3devices_v6_opt="l3devices_v6.disabled=true;" if $l3devices_v6[0];
	my $onclick_opt=$snmp_node_opt . " " . $l2devices_opt . " " . $l3devices_opt . " " . $l2devices_v6_opt . " " . $l3devices_v6_opt;
	print "<tr><td $align><b>$$lang_vars{l2_device_message}</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer2\" onclick=\"$onclick_opt\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l2devices\" size=\"3\" multiple disabled>\n";
	foreach (@l2devices) {
		$_->[1] =~ s/_/-/g;
	...
	print "<tr><td $align><b>$$lang_vars{l2_device_message}</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer2\" disabled></td><td colspan=\"3\" $align1><i>$$lang_vars{no_l2_device_message}</i>\n</td></tr>";
}
...
if ( $l3devices[0] ) {
	...
	$l3devices_v6_opt="l3devices_v6.disabled=true;" if $l3devices_v6[0];
	my $onclick_opt=$snmp_node_opt . " " . $l2devices_opt . " " . $l3devices_opt . " " . $l2devices_v6_opt . " " . $l3devices_v6_opt;
	print "<tr><td $align><b>$$lang_vars{l3_device_message}</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer3\" onclick=\"$onclick_opt\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l3devices\" size=\"3\" multiple disabled>\n";
	foreach (@l3devices) {
		$_->[1] =~ s/_/-/g;
		print "<option>$_->[0] - $_->[1]</option>";
	}
	...
	print "<tr><td $align><b>$$lang_vars{l3_device_message}</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer3\" disabled></td><td colspan=\"3\" $align1><i>$$lang_vars{no_l3_device_message}</i>\n</td></tr>";
}
...
if ( $ipv4_only_mode eq "no" ) {
	...
	if ( $l2devices_v6[0] ) {
		...
		$l3devices_v6_opt="l3devices_v6.disabled=true;" if $l3devices_v6[0];
		my $onclick_opt=$snmp_node_opt . " " . $l2devices_opt . " " . $l3devices_opt . " " . $l2devices_v6_opt . " " . $l3devices_v6_opt;
		print "<tr><td $align><b>$$lang_vars{l2_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer2\" onclick=\"$l2devices_v6_opt\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l2devices_v6\" size=\"3\" multiple disabled>\n" if $l3devices[0];
		print "<tr><td $align><b>$$lang_vars{l2_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer2\" onclick=\"$onclick_opt\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l2devices_v6\" size=\"3\" multiple disabled>\n" if ! $l3devices[0];
		...
		print "<tr><td $align><b>$$lang_vars{l2_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer2\" disabled></td><td colspan=\"3\" $align1><i>$$lang_vars{no_l2_device_message}</i>\n</td></tr>";
	}
	...
	if ( $l3devices_v6[0] ) {
		...
		my $onclick_opt=$snmp_node_opt . " " . $l2devices_opt . " " . $l3devices_opt . " " . $l2devices_v6_opt . " " . $l3devices_v6_opt;
		print "<tr><td $align><b>$$lang_vars{l3_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer3\" onclick=\"$onclick_opt\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l3devices_v6\" size=\"3\" multiple disabled>\n" if $l2devices[0];
		print "<tr><td $align><b>$$lang_vars{l3_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer3\" onclick=\"l3devices_v6.disabled=false;snmp_node.disabled=true;\"></td><td colspan=\"3\" $align1><select class='custom-select custom-select-sm m-2' style='width: 12em' name=\"l3devices_v6\" size=\"3\" multiple disabled>\n" if ! $l2devices[0];
		...
		print "<tr><td $align><b>$$lang_vars{l3_device_message} IPv6</b> <input type=\"radio\" class='m-2' name=\"import_device_type\" value=\"layer3\" disabled></td><td colspan=\"3\" $align1><i>$$lang_vars{no_l3_device_message}</i>\n</td></tr>";
	}
...
<td colspan="3" $align1><select class='custom-select custom-select-sm m-2' style='width: 6em' name="snmp_version" id="snmp_version" onchange="changeText1(this.value);">
...
</td><td colspan="3" $align1><input type="password" class='form-control form-control-sm m-2' style='width: 12em' class='form-control form-control-sm m-2' style='width: 12em' size="10" name="community_string" value="public" maxlength="55"> <span id="Hide12">$$lang_vars{snmp_default_public_message} <img src=\"../imagenes/quick_help.png\" title=\"$$lang_vars{community_explic_message}\" alt=\"help\"></span></td></tr>
...
<tr><td $align>$$lang_vars{port_message}</td><td><input type=\"text\" class='form-control form-control-sm m-2' style='width: 12em' class='form-control form-control-sm m-2' style='width: 12em' size=\"5\" name=\"snmp_port\" value=\"161\" maxlength=\"5\" value=\"161\"></td></tr>
EOF
...
print <<EOF;
<tr><td><br><input type="hidden" name="client_id" value="$client_id"><input type="submit" value="$$lang_vars{query_message}" name=\"B1\" class=\"btn\"></td></tr>
