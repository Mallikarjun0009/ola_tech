...
print "<form  name=\"import_sites_form\" method=\"POST\" action=\"$server_proto://$base_uri/res/ip_import_site_spreadsheet.cgi\">\n";
...
print "<tr><td $align><select class='custom-select custom-select-sm' style='width: 4em' name=\"site\" size=\"1\">";
