...
if ( $admin_type eq "loc_del" ) {
	...
	if ( ! $daten{'loc_add'} ) {
		...
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{locs_message}","$vars_file");
		$gip->print_error("$client_id","<i>$$lang_vars{loc_message}</i>: $$lang_vars{dos_signos_message}");
	} elsif ( $loc !~ /^.{2,60}$/ ) {
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{locs_message}","$vars_file");
	...
	if ( ! $daten{'cat_add'} ) {
		...
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{locs_message}","$vars_file");
		$gip->print_error("$client_id","<i>$$lang_vars{cat_message}</i>: $$lang_vars{dos_signos_message}");
	} elsif ( $cat !~ /^.{1,30}$/ ) {
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{cats_message}","$vars_file");
	...
	if ( ! $daten{'loc_old_rename'} ) {
		...
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{locs_message}","$vars_file");
		$gip->print_error("$client_id","<i>$$lang_vars{loc_message}</i>: $$lang_vars{dos_signos_message}");
	} elsif ( $loc_old_rename !~ /^.{1,60}$/ || $loc_new_rename !~ /^.{1,60}$/) {
		$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{administrar_message} $$lang_vars{cat_net_message}","$vars_file");
...
my $site_management=$global_config[0]->[17] || 0;
$site_management=0 if $site_management eq "no";

if ( $site_management ) {
	print "<i>$$lang_vars{advanced_site_management_enabled_message}</i><p>\n";
print <<EOF;
	<form name="admin" method="POST" action="$server_proto://$base_uri/res/ip_manage_sites.cgi" style="display:inline"><input type="hidden" name="client_id" value="$client_id"><input type="submit" class="btn" value="$$lang_vars{advanced_site_management}" name="B1"></form><p>
EOF
	print "</td><td $align1>\n\n";
} else {
	...
	print "<input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"loc_add\" size=\"10\" maxlength=\"60\"></td></tr>\n";
	print "<tr><td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{crear_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"loc_add\"></form></td></tr></table>\n";

	print "<p><br>\n";
	print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
	print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
	print "<select name=\"loc_del\" class='custom-select custom-select-sm' size=\"1\">\n";
	foreach (@values_locations) {
		print "<option>$values_locations[$j]->[0]</option>\n" if $values_locations[$j]->[0] ne "NULL";
		$j++;
	}
	print "</select></td></tr><tr><td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{borrar_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"loc_del\"></form></td></tr></table>\n";
		

	print "<p><br>\n";
	print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
	print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
	print "<i>$$lang_vars{nombre_actual_message}</i><br><select name=\"loc_old_rename\" class='custom-select custom-select-sm' size=\"1\">\n";
	$j=0;
	foreach (@values_locations) {
		print "<option>$values_locations[$j]->[0]</option>\n" if $values_locations[$j]->[0] ne "NULL";
		$j++;
	}
	print "</select></td><td valign=\"top\"><i>$$lang_vars{nombre_nuevo_message}</i><br><input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"loc_new_rename\" size=\"10\" maxlength=\"60\"></td></tr><tr><td valign=\"top\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{rename_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"loc_rename\"></form></td><td></td></tr></table>\n";
...
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" name=\"admin2\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"cat_add\" size=\"10\" maxlength=\"30\"></td></tr><tr>\n";
print "<td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{crear_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_add\"></form></td></tr></table>\n";


print "<p><br>\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<select name=\"cat_del\" class='custom-select custom-select-sm' size=\"1\">\n";
$j=0;
foreach (@values_categorias) {
	print "<option>$values_categorias[$j]->[0]</option>\n" if $values_categorias[$j]->[0] ne "NULL";
	$j++;
}
print "</select></td></tr><tr><td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{borrar_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_del\"></form></td></tr></table>\n";
	

print "<p><br>\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<i>$$lang_vars{nombre_actual_message}</i><br><select name=\"cat_old_rename\" class='custom-select custom-select-sm' size=\"1\">\n";
$j=0;
foreach (@values_categorias) {
	print "<option>$values_categorias[$j]->[0]</option>\n" if $values_categorias[$j]->[0] ne "NULL";
	$j++;
}
print "</select></td><td valign=\"top\"><i>$$lang_vars{nombre_nuevo_message}</i><br><input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"cat_new_rename\" size=\"10\" maxlength=\"30\"></td></tr><tr><td valign=\"top\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{rename_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_rename\"></form></td><td></td></tr></table>\n";
...
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" name=\"admin2\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"cat_net_add\" size=\"10\" maxlength=\"30\"></td></tr><tr>\n";
print "<td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{crear_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_net_add\"></form></td></tr></table>\n";


print "<p><br>\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<select name=\"cat_net_del\" class='custom-select custom-select-sm' size=\"1\">\n";
$j=0;
foreach (@values_categorias_net) {
	print "<option>$values_categorias_net[$j]->[0]</option>\n" if $values_categorias_net[$j]->[0] ne "NULL";
	$j++;
}
print "</select></td></tr><tr><td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{borrar_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_net_del\"></form></td></tr></table>\n";
	

print "<p><br>\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"1\"><tr><td align=\"left\">";
print "<form method=\"POST\" action=\"$server_proto://$base_uri/res/ip_admin.cgi\">\n";
print "<i>$$lang_vars{nombre_actual_message}</i><br><select name=\"cat_net_old_rename\" class='custom-select custom-select-sm' size=\"1\">\n";
$j=0;
foreach (@values_categorias_net) {
	print "<option>$values_categorias_net[$j]->[0]</option>\n" if $values_categorias_net[$j]->[0] ne "NULL";
	$j++;
}
print "</select></td><td valign=\"top\"><i>$$lang_vars{nombre_nuevo_message}</i><br><input type=\"text\" style='width: 10em;' class='form-control form-control-sm'  name=\"cat_net_new_rename\" size=\"10\" maxlength=\"30\"></td></tr><tr><td valign=\"top\"><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"submit\" value=\"$$lang_vars{rename_message}\" name=\"B2\" class=\"btn\"><input type=\"hidden\" name=\"admin_type\" value=\"cat_net_rename\"></form></td><td></td></tr></table>\n";
