...
my $collapse_networks=$daten{'hide_not_rooted'};
if ( $collapse_networks eq "create" ) {
    $collapse_networks=1;
} else {
    $collapse_networks=0;
}
...
#my $div_inhalt = GipTemplate::create_div_inhalt(
#	noti => $noti_noti,
#);
...
#        $collapse_networks=$gip->get_hide_not_rooted_val();
}
