...
print "<tr><td $align>$$lang_vars{dns_server_type_message_zone_file_message}</td><td><select class='custom-select custom-select-sm' name=\"server_type\" id=\"server_type\" size=\"1\" onchange=\"changeText1(this.value);\">";
...
print "<tr><td $align>$$lang_vars{domain_message}</td><td $align1><input name=\"domain\" type=\"text\" class='form-control form-control-sm'  size=\"15\" maxlength=\"100\" value=\"\"></td></tr>\n";
print "<tr><td $align>$$lang_vars{serial_message}</td><td $align1><input name=\"serial\" type=\"text\"  class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"$serial\"></td></tr>\n";
print "<tr><td $align>$$lang_vars{refresh_message}</td><td $align1><input name=\"refresh\" type=\"text\" class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"24h\"></td></tr>\n";
print "<tr><td $align>$$lang_vars{retry_message}</td><td $align1><input name=\"retry\" type=\"text\" class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"2h\"></td></tr>\n";
print "<tr><td $align>$$lang_vars{expire_message}</td><td $align1><input name=\"expire\" type=\"text\" class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"1000h\"></td></tr>\n";
print "<tr><td $align>$$lang_vars{minimum_message}</td><td $align1><input name=\"minimum\" type=\"text\" class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"2d\"></td></tr>\n";
print "<tr><td $align>TTL</td><td $align1><input name=\"TTL\" type=\"text\" class='form-control form-control-sm' size=\"8\" maxlength=\"20\" value=\"1h\"></td></tr>\n";
print "<tr><td $align>Nameserver<br>(master)</td><td $align1><input name=\"nameserver1\" type=\"text\" class='form-control form-control-sm' size=\"20\" maxlength=\"50\" value=\"\"></td></tr>\n";
print "<tr><td $align>Nameserver<br>(slave)</td><td $align1><input name=\"nameserver2\" type=\"text\" class='form-control form-control-sm' size=\"20\" maxlength=\"50\" value=\"\"></td></tr>\n";
#print "<tr><td $align>Nameserver III</td><td $align1><input name=\"nameserver3\" type=\"text\" size=\"20\" maxlength=\"50\" value=\"\"></td></tr>\n";
print "<tr><td $align>Mailserver I</td><td $align1><input name=\"mailserver1\" type=\"text\" class='form-control form-control-sm' size=\"20\" maxlength=\"50\" value=\"\"></td></tr>\n";
print "<tr><td $align>Mailserver II</td><td $align1><input name=\"mailserver2\" type=\"text\" class='form-control form-control-sm' size=\"20\" maxlength=\"50\" value=\"\"></td></tr>\n";
