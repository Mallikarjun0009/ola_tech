...
$gip->CheckInput("$client_id",\%daten,"$$lang_vars{mal_signo_error_message}","$$lang_vars{buscar_message} ","$vars_file");
...
print "<p>\n";
print "<form name=\"insert_acl_connection_form\" method=\"POST\" action=\"./ip_search_acl_connection.cgi\">\n";
print "<table border=\"0\" cellpadding=\"5\" cellspacing=\"2\">\n";

print "<tr><td $align>$$lang_vars{exact_match_message}<p></p></td><td $align1><input type=\"checkbox\" name=\"exact_match\" value=\"exact_match\"><p></p></td></tr>\n";
print "<tr><td $align>$$lang_vars{con_nr_message}</td><td $align1><input name=\"acl_nr\" type=\"text\" class='form-control form-control-sm m-2' style='width: 6em' value=\"\" size=\"5\" maxlength=\"50\"></td></tr>\n";
...
my $j=0;
print "<tr><td $align>$$lang_vars{protocol_message}</td><td $align1><select name=\"proto_id\" class=\"custom-select custom-select-sm m-2 display-inline\" style='width: 12em' size=\"1\">\n";
print "<option></option>";
...
print "<tr><td align='left' colspan='2'><p></p>$$lang_vars{ignore_acl_message} <input type=\"radio\" class='m-2' name=\"no_acl\" value=\"ignore_acl\" checked> $$lang_vars{with_acl_message}<input type=\"radio\" class='m-2' name=\"no_acl\" value=\"with_acl\">$$lang_vars{without_acl_message}<input type=\"radio\" class='m-2' name=\"no_acl\" value=\"without_acl\"></td></tr>\n";
print "<tr><td><input type=\"hidden\" name=\"client_id\" value=\"$client_id\"><input type=\"hidden\" id=\"advanced\" name=\"advanced\" value=\"advanced\"><br><input type=\"submit\" value=\"$$lang_vars{buscar_message}\" name=\"B2\" class=\"btn\"><br>\n";
